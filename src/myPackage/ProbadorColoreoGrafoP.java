...
public class ProbadorColoreoGrafoP {

	private ArrayList<Arista> entrada;
	private ArrayList<NodoColoreado> salida;
	private int cantNodos;

	public ProbadorColoreoGrafoP(String pathIn, String pathOut) throws FileNotFoundException {
		...
		for(int i = 0 ; i < cantAristas ; i++) {
			fil = scan.nextInt(); // nodo 1
			col = scan.nextInt(); // nodo 2
			scan.nextInt(); // no guardo el peso ya que no lo necesito
